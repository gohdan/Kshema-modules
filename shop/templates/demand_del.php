...
{{if:admin_link:<p><a href="/index.php?module=shop&action=demand_view">К просмотру заявок</a></p>}}

<hr>

<p>Вы действительно хотите удалить заявку<b>#id#</b>?</b>

<form action="/index.php?module=shop&action=demand_view" method="post">
