...
{{if:show_edit_link:<td style="padding: 0px 3px 0px 3px"><a href="/shop/goods_edit/goods:#id#">Редактировать</a></td>}}
{{if:show_del_link:<td style="padding: 0px 3px 0px 3px"><a href="/shop/goods_del/goods:#id#">Удалить</a></td>}}
