...
<b><a href="/index.php?module=shop&action=view_by_authors&authors=#author#">#author_name#</a></b><br>
<b><a href="/index.php?module=shop&action=view_by_categories&categories=#category#">#category_name#</a></b><br>
</div>
{{if:show_request_link:<div style="display: inline">Сейчас товара в наличии нет.<br>Вы можете <a href="/index.php?module=shop&action=view_good&good=#id#">оставить заявку</a></div>}}
</td>
